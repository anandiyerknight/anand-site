  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-5 md:p-6 flex items-end justify-between gap-4">
        ...
        <div className="shrink-0 w-10 h-10 rounded-full border border-white/30 flex items-center justify-center group-hover:bg-[var(--color-cyan)] group-hover:border-[var(--color-cyan)] group-hover:text-[var(--color-bg)] transition">
